    ...
    function showDeclinedPopup() {
      ...
      showSheetMessage(`Returning you to your RentReady results. You can retry Luxury Apartment Listings for ${city} when you’re ready.`);
    ...
    function resetSheetMessage() {
      ...
      sheetTitle.textContent = "We Couldn’t Complete Your Upgrade Yet.";
      sheetSub.textContent = `Returning you to your RentReady results. You can retry Luxury Apartment Listings in ${selectedCity()} when you’re ready.`;
      sheetConfirm.textContent = originalConfirmText;
