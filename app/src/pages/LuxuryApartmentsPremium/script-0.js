    ...
    checkoutBtn.addEventListener('click', handleLuxuryPurchase);
    ...
    function pollForLuxuryCompletion() {
      let attempts = 0;
      const check = async () => {
        attempts++;
    ...
    function showDeclinedPopup() {
      ...
      showSheetMessage(`Returning you to your RentReady listings. You can retry Luxury Apartment Listings for ${city} when you’re ready.`);
    ...
    function resetSheetMessage() {
      ...
      sheetTitle.textContent = "We Couldn’t Complete Your Upgrade Yet.";
      sheetSub.textContent = `Returning you to your RentReady listings. You can retry Luxury Apartment Listings in ${selectedCity()} when you’re ready.`;
      sheetConfirm.textContent = originalConfirmText;
